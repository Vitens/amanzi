<template>
    <svg>
      <path :d="ionex.oval" fill="none" stroke="black" stroke-width="2"  /> 
      <rect :x="ionex.rect.x" :y="ionex.rect.y" :width="ionex.rect.width" :height="ionex.rect.height" fill="white" stroke-width="2" stroke="black"/> 
      <path :d="ionex.cross" fill="none" stroke="black" stroke-width="2"  />
    </svg>
    
<!-- 
    <svg>
        <use xmlns="http://www.w3.org/2000/svg" xlink:href="#A" xmlns:xlink="http://www.w3.org/1999/xlink" x=".5" y=".5"/><symbol xmlns="http://www.w3.org/2000/svg" id="A" overflow="visible"><g stroke-width=".5"><path d="M0 0h40v60H0z"/><g fill="none"><path d="M0 50h40M0 10h40" stroke-dasharray="2.5 3" stroke-linecap="butt"/><path d="M0 20h40M0 40h40"/></g></g></symbol>
        <symbol xmlns="http://www.w3.org/2000/svg" id="A" overflow="visible"><g stroke-width=".5"><path d="M0 0h40v60H0z"/><g fill="none"><path d="M0 50h40M0 10h40" stroke-dasharray="2.5 3" stroke-linecap="butt"/><path d="M0 20h40M0 40h40"/></g></g></symbol>
    </svg> -->
    </template>
