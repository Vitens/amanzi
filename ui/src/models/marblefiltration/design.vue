<template>
  <el-tab-pane id="marblefilter-design">
    <template #label>
...
#marblefilter-table tr td:first-child {
  font-weight: bold;
  text-align: left;
  padding-right: 10px;
}
#marblefilter-table td {
  padding: 5px;
}
#marblefilter-table td {
  border-bottom: 1px solid #CCC;
}
#marblefilter-design .depth-charts .result-chart {
  height: 430px;
}
#marblefilter-design .depth-charts ul {
  margin-top: 60px;
  padding: 0;
  display: flex;
...
#marblefilter-design .depth-charts ul li {
  text-align: right;
  list-style: none;
}
#marblefilter-design .effluent {
  right: 10%;
  bottom: 2%;
}

#marblefilter-table .warning {
  color: #F56C6C;
  font-weight: bold;
}
