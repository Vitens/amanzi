...
async function initPyodide() {
  ...
  await pip.install('https://www.abelheinsbroek.nl/phreeqpython-1.6.1-py3-none-any.whl');
  await pip.install('https://www.abelheinsbroek.nl/amanzi-1.0.10-py2.py3-none-any.whl');
