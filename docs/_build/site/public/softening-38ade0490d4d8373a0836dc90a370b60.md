...
Pellet softening is commonly used for:
- **Hardness removal** - Reduction of calcium and magnesium
- **Iron removal** - Precipitation of ferrous iron
- **Manganese removal** - Precipitation of manganous manganese
- **pH adjustment** - Control of water pH
- **Corrosion control** - Prevention of corrosion in distribution systems
- **Scale prevention** - Prevention of scaling in downstream processes
