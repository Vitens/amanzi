...
Groundwater models are used for:
- **Source water characterization** - Understanding raw water quality
- **Treatment design** - Determining required treatment processes
- **Oxygen demand calculation** - Sizing aeration systems
- **Chemical dosing** - Calculating chemical requirements
- **Process optimization** - Optimizing treatment sequences
