...
class Cascade(Model, Balance):
    ...
    def gas_properties(self):
        ...
        return   {
                  'O2':{'k_eff': (28.85*log(self.step_height)+50.066), 'c_sat': 11.3, 'MW': 32}, #O2
    ...
    def design(self):
        ...
        for steps in range(1,9): # 8 is the maximum number of steps
            ...
            o2.append({'x': steps, 'y': design_effluents.total("O2", "mg") })            
            ...
            o2_eff.append({'x': steps, 'y': ((design_effluents.total("O2", "mmol") / oxg_saturation)) * 100})
