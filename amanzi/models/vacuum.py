    ...
    def design(self):
      ...
      return {
         'influent': {
            ...
            'h2s': self.quality.influent.product.elements.get('Sg', 0) * 34082,
         },
         'effluent': {
            'pH': effluent.pH,
            ...
            'h2s': effluent.elements.get('Sg', 0) * 34082,
         },
         'gas_dry': {
            ...
            'h2o': 0,
            'volume': effluent_gas.dry_volume,
            'normal_volume': effluent_gas.dry_volume * self.pressure,
         },
         'gas_wet': {
            'ch4': effluent_gas.fractions['Mtg(g)'] * 100,
            'n2': effluent_gas.fractions['Ntg(g)'] * 100,
            'co2': effluent_gas.fractions['CO2(g)'] * 100,
            'h2s': effluent_gas.fractions['H2Sg(g)'] * 100,
            'h2o': effluent_gas.fractions['H2O(g)'] * 100,
