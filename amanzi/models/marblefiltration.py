...
class Marblefiltration(Model, Balance):
    parametric_model = ['base', 'model', 'marblefiltration']
    ...
    def run_quality(self, type, total_inflow, solution):
        ...
        if(type == 'product'):
            ...
            if self.parameters['gj']:
                self.create_arrays()
                self.sieve_analysis()
                self.oxidation()
                self.acidification()
                effluent = self.inflow
                effluent.add('O2', 4.54, 'mg')
                steps = [self.quality.influent.product.copy(), self.layer_mixture[1], self.layer_mixture[2], self.layer_mixture[3], self.layer_mixture[4], self.layer_mixture[5], self.inflow]
            else:
    ...
    # def plots(self):
    #     # print results and save to Excel file
        
    #     k=0
    #     params = {'legend.fontsize': 7,'figure.figsize': (15, 15),'axes.labelsize': 15,'axes.titlesize': 15,'xtick.labelsize':15,'ytick.labelsize':15}
          
    #     # workbook = xlrd.open_workbook(self.file_location)
    #     # sheet = workbook.sheet_by_index(5)
        
    #     #self.Fe_height_start = (sheet.cell_value(9,2))
        
    #     pylab.rcParams.update(params)
    #     nbins=4
    #     a=[];b=[];c=[];d=[];e=[];f=[];g=[];h=[];i=[];j=[];l=[];m=[]
        
    #     number_of_results = int(sheet.cell_value(3,23))
        
    #     for z in range(0,number_of_results):
    #         a.append(sheet.cell_value(4+z,1)) # bed height
    #         b.append(sheet.cell_value(4+z,2)) # pH
    #         c.append(sheet.cell_value(4+z,3)) # aggressive CO2
    #         d.append(sheet.cell_value(4+z,4)) # SI
    #         e.append(sheet.cell_value(4+z,5)) # CO2
    #         f.append(sheet.cell_value(4+z,6)) # Ca
    #         g.append(sheet.cell_value(4+z,7)) # HCO3
    #         h.append(sheet.cell_value(4+z,8)) # TAC
    #         i.append(sheet.cell_value(4+z,9)) # iron
    #         j.append(sheet.cell_value(4+z,10)) # manganese
    #         l.append(sheet.cell_value(4+z,11)) # ammonium
    #         m.append(sheet.cell_value(4+z,12)) # EC
        
    #     #print (e)
    #     #print (f)
        
    #     #def total_plot_SI(ax):
    #     #    ax.plot(self.runs,self.SI_after_run)
    ...
    #     def iron_plot(ax):
    #         #ax.plot(self.iron_after_ox[self.k,0:self.height_counter[self.k],0], self.bed_layer_height_sum_top2_descending[self.k,0:self.height_counter[self.k],0])
    #         ax.plot(self.iron_after_ox[self.k,0:int(self.height_counter[self.k]),0], self.bed_layer_height_sum_top2_descending[self.k,0:int(self.height_counter[self.k]),0])
    #         #ax.plot(self.iron_after_ox[0,0:100,0], self.bed_layer_height_sum_top2_descending[0,0:100,0])
    #         ax.locator_params(nbins=nbins)
    #         #ax.scatter(i,a,s=50)
    #         ax.set_facecolor((0.95,1.0,1.0))
    #         ax.set_xlim((0.0))
    ...
    #         ax.minorticks_on()
    #         ax.set_xlabel('Fe content (mg/l)')
    #         ax.set_ylabel('bed height (m)')
    
    #     def manganese_plot(ax):
    #         ax.plot(self.manganese_after_ox[self.k,0:int(self.height_counter[self.k]),0], self.bed_layer_height_sum_top2_descending[self.k,0:int(self.height_counter[self.k]),0])
    #         ax.locator_params(nbins=nbins)
    #         #ax.scatter(j,a,s=50)
    #         ax.set_facecolor((0.95,1.0,1.0))
    #         ax.set_xlim((0.0))
    ...
    #         ax.grid(which='minor', linewidth=0.1)
    #         ax.minorticks_on()
    #         ax.set_xlabel('Mn content (mg/l)')
    #         ax.set_ylabel('bed height (m)')
    
    #     def ammonium_plot(ax):
    #         ax.plot(self.ammonium_after_ox[self.k,0:int(self.height_counter[self.k]),0], self.bed_layer_height_sum_top2_descending[self.k,0:int(self.height_counter[self.k]),0])
    #         ax.locator_params(nbins=nbins)
    #         #ax.scatter(l,a,s=50)
    #         ax.set_facecolor((0.95,1.0,1.0))
    #         ax.set_xlim((0.0))
    ...
    #         ax.grid(which='minor', linewidth=0.1)
    #         ax.minorticks_on()
    #         ax.set_xlabel('NH$_4$ content (mg/l)')
    #         ax.set_ylabel('bed height (m)')

    #     #def acid_mol_plot(ax):
    #         #ax.plot(self.acid_mol[self.k,0:self.height_counter[k],0],self.bed_layer_height_sum_top2_descending[self.k,0:self.height_counter[self.k],0])
    #         #ax.locator_params(nbins=nbins)
    #         #ax.set_xlim((0,80))
    #         #ax.set_ylim((0,2.5))
    #         #ax.set_xlabel('acid (mmol)')
    #         #ax.set_ylabel('bed height (m)')
            
    #     def Sieve_plot(ax):
    #         print(self.grain_diameter[2,0,::])                #,' mm ',self.bed_layer_height_partial[self.k,j,i], ' m ')
    #         ax.plot(self.sieve_size_print,self.passage_percentage)
    #         ax.locator_params(nbins=nbins)
    #         ax.set_xlim((0.0))
    #         ax.set_ylim((0,100))
    #         ax.grid(which='major', linewidth=0.5)
    ...
    #     def agr_CO2_plot(ax):
    #         ax.plot(self.agr_CO2_print[self.k,0:int(self.height_counter[self.k]),0],self.bed_layer_height_sum_top2_descending[self.k,0:int(self.height_counter[self.k]),0],'r-')
    #         ax.locator_params(nbins=nbins)
    #         #ax.scatter(c,a,s=50)
    #         ax.set_xlim((0.0))
    #         ax.set_ylim((0,3))
    #         #ax.set_axis_bgcolor((0.95,1.0,1.0))
    #         ax.set_facecolor((0.95,1.0,1.0))
    #         ax.set_xlabel('agr CO$_2$ (mg/l)')
    #         ax.set_ylabel('bed height (m)')
    #         ax.grid(which='major', linewidth=0.5)
    #         ax.grid(which='minor', linewidth=0.1)
    #         ax.minorticks_on()
    ...
    #     def pH_plot(ax):
    #         ax.plot(self.pH_print[self.k,0:int(self.height_counter[self.k]),0],self.bed_layer_height_sum_top2_descending[self.k,0:int(self.height_counter[self.k]),0],'r-')
    #         ax.locator_params(nbins=nbins)
    #         #ax.scatter(b,a,s=50)
    #         ax.set_facecolor((0.95,1.0,1.0))
    #         #ax.set_xlim((0,80))
    ...
    #     def SI_plot(ax):
    #         ax.plot(self.SI_print[self.k,0:int(self.height_counter[self.k]),0],self.bed_layer_height_sum_top2_descending[self.k,0:int(self.height_counter[self.k]),0],'r-')
    #         ax.locator_params(nbins=nbins)
    #         #ax.scatter(d,a,s=50)
    #         ax.set_xlim(right=0)
    #         ax.set_ylim((0,3))
    ...
    #     def Ca_plot(ax):
    #         ax.plot(self.Ca_print[self.k,0:int(self.height_counter[self.k]),0],self.bed_layer_height_sum_top2_descending[self.k,0:int(self.height_counter[self.k]),0],'r-')
    #         ax.locator_params(nbins=nbins)
    #         #ax.scatter(f,a,s=50)
    #         ax.set_facecolor((0.95,1.0,1.0))
    #         ax.set_xlim((0.0))
    #         ax.set_ylim((0,3))
    #         ax.set_xlabel('Calcium (mg/l)')
    #         ax.set_ylabel('bed height (m)')
    #         ax.grid(which='major', linewidth=0.5)
    #         ax.grid(which='minor', linewidth=0.1)
    #         ax.minorticks_on()
    ...
    #     def HCO3_plot(ax):
    #         ax.plot(self.HCO3_print[self.k,0:self.number_of_heights,0],self.bed_layer_height_sum_top2_descending[self.k,0:self.number_of_heights,0],'r-')
    #         ax.locator_params(nbins=nbins)
    #         #ax.scatter(g,a,s=50)
    #         ax.set_facecolor((0.95,1.0,1.0))
    #         ax.set_xlim((0.0))
    #         ax.set_ylim((0,3))
    #         ax.set_xlabel('HCO$_3$ (mg/l)')
    #         ax.set_ylabel('bed height (m)')
    #         ax.grid(which='major', linewidth=0.5)
    #         ax.grid(which='minor', linewidth=0.1)
    #         ax.minorticks_on()
    ...
    #     def EC_plot(ax):
    #         ax.plot(self.EC_print[self.k,0:int(self.height_counter[self.k]),0],self.bed_layer_height_sum_top2_descending[self.k,0:int(self.height_counter[self.k]),0],'r-')
    #         ax.locator_params(nbins=nbins)
    #         #ax.scatter(m,a,s=50)
    #         ax.set_facecolor((0.95,1.0,1.0))
    #         ax.set_xlim(left=0)
    ...
    #     def CO2_plot(ax):
    #         ax.plot(self.CO2_print[self.k,0:int(self.height_counter[self.k]),0],self.bed_layer_height_sum_top2_descending[self.k,0:int(self.height_counter[self.k]),0],'r-')
    #         #ax.plot(self.agr_CO2_print[self.k,0:int(self.height_counter[self.k]),0],self.bed_layer_height_sum_top2_descending[self.k,0:int(self.height_counter[self.k]),0],'r-', color='black')
    ...
    #     def TAC_plot(ax):
    #         ax.plot(self.TAC_print[self.k,0:int(self.height_counter[self.k]),0],self.bed_layer_height_sum_top2_descending[self.k,0:int(self.height_counter[self.k]),0],'r-')
    #         ax.locator_params(nbins=nbins)
    #         ax.set_facecolor((0.95,1.0,1.0))
    #         ax.set_xlim(0,)
    #         #ax.set_ylim((0,3))  #ax.set_ylim((-1,0))
    #         ax.set_xlabel('TAC (mmol/l)')
    #         ax.set_ylabel('bed height (m)') 
    #         ax.grid(which='major', linewidth=0.5)
    #         ax.grid(which='minor', linewidth=0.1)
    #         ax.minorticks_on()
    ...
    #     def total_plot_SI(ax):
    #         ax.plot(self.runs,self.SI_after_run,'r-')
    #         ax.locator_params(nbins=nbins)
    #         ax.set_facecolor((0.95,1.0,1.0))
    #         ax.set_xlim(0,)
    #         ax.set_ylim((-1,0))
    ...
    #     def total_plot_agrCO2(ax):
    #         ax.plot(self.runs,self.agrCO2_after_run,'r-')
    #         ax.locator_params(nbins=nbins)
    #         ax.set_facecolor((0.95,1.0,1.0))
    #         ax.set_xlim(0,)
    #         ax.set_ylim(0,)
    #         ax.set_ylabel('aggressive CO2 (mg/l)')
    #         ax.set_xlabel('run (n)')
    #         ax.grid(which='major', linewidth=0.5)
    #         ax.grid(which='minor', linewidth=0.1)
    #         ax.minorticks_on()
            
    #     def total_plot_bed_height(ax):
    #         ax.plot(self.runs,self.height_after_run,'r-')
    #         ax.locator_params(nbins=nbins)
    #         ax.set_facecolor((0.95,1.0,1.0))
    #         ax.set_xlim(0,)
    #         ax.set_ylim(0,)
    ...
    #     print(self.runs,self.SI_after_run)
    #     print(self.bed_layer_height_sum_top2_descending[self.k,0:int(self.height_counter[self.k]),0])
    ...
    #     TAC_plot(ax12)
    #     total_plot_SI(ax13)
    #     total_plot_agrCO2(ax14)
    #     total_plot_bed_height(ax15)
        
    #     plt.tight_layout(pad=1,w_pad=1,h_pad=1)
    #     fig.set_figheight(29)
    #     fig.set_figwidth(15)  
    #     self.timestr = time.strftime("%Y %m %d - %H %M %S")
    #     fig.savefig("Westerlo_right_table_4p6mph_500X.png") ############################################ HERE!
